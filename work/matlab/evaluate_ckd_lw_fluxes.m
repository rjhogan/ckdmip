...
ickd_stats = max(ickd); % Which CKD model do we show the stats for (0=none)
...
if do_plot
if do_legend
  set(legend(leg,'location','northeast'),'fontsize',legfontsize','box','on')
end
